def filter_by_state(input_list: list[dict], state='EXECUTED') -> list[dict]:
...
def sort_by_date(input_list: list[dict], decreasing=True) -> list[dict]:
...
if __name__ == "__main__":
    ...
    print(sort_by_date(in_list, False))
